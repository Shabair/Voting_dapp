let EcContractAddress = "0xa1c1764C2fE74f9F0b50aaA0E2cf72a478030Ba6";
...
const getCandidateContract = async (web3) => {
  ...
  await ec_contract.methods
    .getCandidateContractAddress()
    .call((error, result) => {
      if (result) {
        candidateContractAddress = result;
        console.log("Loaded Candidate Contract Address: " + result);

        candidate_contract = new web3.eth.Contract(
          ec_data.abi,
